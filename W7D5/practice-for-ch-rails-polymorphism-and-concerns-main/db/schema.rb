...
ActiveRecord::Schema[7.0].define(version: 2023_02_24_115304) do
  ...
  create_table "toys", force: :cascade do |t|
    t.string "name"
    t.string "toyable_type_type", null: false
    t.bigint "toyable_type_id", null: false
    ...
    t.index ["toyable_type_type", "toyable_type_id"], name: "index_toys_on_toyable_type"
  end
